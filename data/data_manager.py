...
def get_connection_data(db_name=None):
    ...
    """
    if db_name is None:
        db_name = os.environ.get('MY_PSQL_DBNAME', 'codecool_series')

    return {
        'dbname': db_name,
        'user': os.environ.get('MY_PSQL_USER', 'soare'),
        'host': os.environ.get('MY_PSQL_HOST', 'localhost'),
        'password': os.environ.get('MY_PSQL_PASSWORD', '2302')
    }
